---
title: "Kein Urlaub vom Schma"
date: 2026-05-10
draft: false
description: "Über die Illusion der Pause, die Trennung von Religion und Alltag und die Kunst, im Kriat Schma echte Konzentration zu finden."
tags: ["gebet", "kavana", "schma", "alltag", "judentum", "tanja"]
categories: ["lehre"]
personas: ["lehre"]
---
...
```mermaid
flowchart LR
    S((Schma)) --> O[Olam<br/>Ort]
    S --> Z[Zman<br/>Zeit]
    S --> N[Nefesch<br/>Seele]

    O --> O1[im Haus]
    O --> O2[auf dem Weg]
    O --> O3[an Tür und Tor]

    Z --> Z1[beim Niederlegen]
    Z --> Z2[beim Aufstehen]

    N --> N1[Machschawa<br/>auf dem Herzen]
    N --> N2[Dibbur<br/>davon sprechen]
    N --> N3[Maasse<br/>an der Hand binden]

    classDef source fill:#f1efe8,stroke:#5f5e5a,color:#2c2c2a
    classDef olam fill:#faece7,stroke:#993c1d,color:#4a1b0c
    classDef zman fill:#e1f5ee,stroke:#0f6e56,color:#04342c
    classDef nefesch fill:#eeedfe,stroke:#534ab7,color:#26215c

    class S source
    class O,O1,O2,O3 olam
    class Z,Z1,Z2 zman
    class N,N1,N2,N3 nefesch
```
